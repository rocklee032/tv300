...
//-------------------------------------------------------------------------------------------------
/// Description : Get Unique ID
/// @param  pu8UIDData    \b OUT: Virtual data ptr to store the read Unique ID data
/// @param  u32IDSize    \b IN: size in Bytes
/// @return the SPI Flash's Unique ID
/// @return TRUE : succeed
/// @return FALSE : fail
...
/// [NONOS_SUPPORT]
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MDrv_SERFLASH_ReadUID_New(MS_U8 *pu8UIDData, MS_U32 u32IDSize);
