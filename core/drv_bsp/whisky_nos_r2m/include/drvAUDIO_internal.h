...
typedef enum
{
    ...
    AU_AUTHBIT_FW_DDCO,
    AU_AUTHBIT_FW_DTS,
    AU_AUTHBIT_FW_MS10DDT,
    AU_AUTHBIT_FW_WMA,
    AU_AUTHBIT_FW_DRA,
    AU_AUTHBIT_FW_DTSLBR,
    AU_AUTHBIT_FW_GAAC,
    AU_AUTHBIT_FW_MS11,
    AU_AUTHBIT_FW_DTSE,
    AU_AUTHBIT_FW_DTSNeoUltra,
    AU_AUTHBIT_FW_DemoMode,
    AU_AUTHBIT_FW_SRSTSHD,
    AU_AUTHBIT_FW_SRSTheaterSound,
    AU_AUTHBIT_FW_DTSStudioSound3D,
    AU_AUTHBIT_FW_COOK,
    AU_AUTHBIT_FW_DTSHD,
    AU_AUTHBIT_FW_MS12LC,
    AU_AUTHBIT_FW_MS12D,
    AU_AUTHBIT_FW_ABS3D,
    AU_AUTHBIT_FW_MS12B,
    AU_AUTHBIT_FW_DolbyVolume,
    AU_AUTHBIT_FW_SRSPureSound,
    AU_AUTHBIT_FW_MAX,
}AUDIO_HASHKEY_FWBIT;
