...
#define TCON_DUMMYINFO_VERSION                          1
//-------------------------------------------------------------------------------------------------
//  Type and Structure
//-------------------------------------------------------------------------------------------------
...
typedef struct
{
    ...
    MS_U16  u16HDE_HeadDummy;       //HDE head dummy line
    MS_U16  u16HDE_TailDummy;          //HDE tail dummy line
    MS_U16  u16VDE_HeadDummy;       //VDE head dummy line
    MS_U16  u16VDE_TailDummy;          //VDE tail dummy line
} PNL_ApiExtStatus;
...
typedef struct
{
    MS_U32 u32TCON_DummInfoVersion;
    MS_U32 u32TCON_DummInfoLength;

    MS_U16 u16HDE_HeadDummy;
    MS_U16 u16HDE_TailDummy;
    MS_U16 u16VDE_HeadDummy;
    MS_U16 u16VDE_TailDummy;

} MS_PNL_TCON_DummyInfo;
...
// Set TCON Dummy Info
//-------------------------------------------------------------------------------------------------
MS_BOOL MApi_PNL_TCON_SetDummyInfo(MS_PNL_TCON_DummyInfo stTCONInfo);
