...
//================================================================
//  IP Security FW Bit Enum
//================================================================
typedef enum
{
    AU_AUTHBIT_FW_AC3,              //ip_auth[0] = 1: Disable AC3
    AU_AUTHBIT_FW_AC3P,             //ip_auth[1] = 1: Disable AC3P
    AU_AUTHBIT_FW_DDCO,             //ip_auth[2] = 1: Disable DDCO (HE-AAC)
    AU_AUTHBIT_FW_DTS,              //ip_auth[3] = 1: Disable DTS
    AU_AUTHBIT_FW_MS10DDT,          //ip_auth[4] = 1: Disable Dolby MS10-DDT (HE-AAC)
    AU_AUTHBIT_FW_WMA,              //ip_auth[5] = 1: Disable WMA
    AU_AUTHBIT_FW_DRA,              //ip_auth[6] = 1: Disable DRA
    AU_AUTHBIT_FW_DTSLBR,           //ip_auth[7] = 1: Disable DTSLBR
    AU_AUTHBIT_FW_GAAC,             //ip_auth[8] = 1: Disable Generic HE-AAC
    AU_AUTHBIT_FW_MS11,             //ip_auth[9] = 1: Disable Dolby MS11
    AU_AUTHBIT_FW_DTSE,             //ip_auth[10]= 1: Disable DTSE
    AU_AUTHBIT_FW_DTSNeoUltra,      //ip_auth[11]= 1: Disable DTS NeoUltra
    AU_AUTHBIT_FW_DemoMode,         //ip_auth[12]= 1: Demo Mode
    AU_AUTHBIT_FW_SRSTSHD,          //ip_auth[13]= 1: Disable SRS_TSHD
    AU_AUTHBIT_FW_SRSTheaterSound,  //ip_auth[14]= 1: Disable SRS_THEATERSOUND
    AU_AUTHBIT_FW_DTSStudioSound3D, //ip_auth[15]= 1: Disable DTS StudioSound3D
    AU_AUTHBIT_FW_COOK,             //ip_auth[16]= 1: Disable COOK
    AU_AUTHBIT_FW_DTSHD,            //ip_auth[17]= 1: Disable DTS XLL
    AU_AUTHBIT_FW_MS12LC,           //ip_auth[18]= 1: Disable MS12 LC profile
    AU_AUTHBIT_FW_MS12D,            //ip_auth[19]= 1: Disable MS12 D profile
    AU_AUTHBIT_FW_ABS3D,            //ip_auth[20]= 1: Disable ABS3D
    AU_AUTHBIT_FW_MS12B,            //ip_auth[21]= 1: Disable MS12 B profile
    AU_AUTHBIT_FW_DolbyVolume,      //ip_auth[22]= 1: Disable Dolby Volume
    AU_AUTHBIT_FW_SRSPureSound,     //ip_auth[23]= 1: Disable SRS_PURESND
    AU_AUTHBIT_FW_MAX,
}AUDIO_HASHKEY_FWBIT;
