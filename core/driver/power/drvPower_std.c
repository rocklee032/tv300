...
void MDrv_Power_PrintWakeUpFlag(U32 u32Flag)
{
    ...
    if( u32Flag&PM_WAKEUP_BY_IR )
        printf(" IR,");

    if( u32Flag&PM_WAKEUP_BY_KEYPAD )
        printf(" KEYPAD,");

    if( u32Flag&PM_WAKEUP_BY_DDC )
        printf(" DDC,");

    if( u32Flag&PM_WAKEUP_BY_UART )
        printf(" UART,");

    if( u32Flag&PM_WAKEUP_BY_USB )
        printf(" USB,");

    if( u32Flag&PM_WAKEUP_BY_MHL )
        printf(" MHL,");
...
void MDrv_Power_Standby_CheckWakeupDevice(void)
{
    ...
    //stPowerGenSetting.wPM_WakeUpDevice |= PM_WAKEUP_DEBUG;
...
#if (ENABLE_CI && ((CHIP_FAMILY_TYPE == CHIP_FAMILY_MILAN) ||(CHIP_FAMILY_TYPE == CHIP_FAMILY_MARLON)))
 //###########################################
//The API only for Milan/Marlon to reduce standby power consumption when inserting CI card
static void MDrv_Power_DisablePCMCIA_PIN(void)
{

    printf("DisablePCMCIA_PIN CI\n");
    MDrv_WriteByteMask(0x101e6c, 0, BIT0);
    MDrv_WriteByteMask(0x101e6e, 0, BIT0);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0f, 0xff, 0xff );   //reg[101e0f]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e10, BIT1|BIT0 , BIT1|BIT0 );   //reg[101e10]#1 ~#0 = 3h
    //reg_pcmadconfig[4] = 0b
    MDrv_WriteByteMask(0x101ec8, 0, BIT4 );   //reg[101ec8]#4 = 00b
    //reg_ts_out_mode[5:4] = 00b
    MDrv_WriteByteMask(0x101eaa, 0, BIT5|BIT4 );   //reg[101eaa]#5~#4 = 00b

    MDrv_WriteByteMask(0x101e6c, 0, BIT1);
    MDrv_WriteByteMask(0x101e6e, 0, BIT1);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6c, 0, BIT2);
    MDrv_WriteByteMask(0x101e6e, 0, BIT2);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6c, 0, BIT3);
    MDrv_WriteByteMask(0x101e6e, 0, BIT3);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6c, 0, BIT4);
    MDrv_WriteByteMask(0x101e6e, 0, BIT4);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101ec8, 0, BIT4 );   //reg[101ec8]#4 = 00b
    //reg_fiveuartmode = 0b
    MDrv_WriteByteMask(0x101e3e, 0, BIT1 );   //reg[101e3e]#1 = 00b


    MDrv_WriteByteMask(0x101e6c, 0, BIT5);
    MDrv_WriteByteMask(0x101e6e, 0, BIT5);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6c, 0, BIT6);
    MDrv_WriteByteMask(0x101e6e, 0, BIT6);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6c, 0, BIT7);
    MDrv_WriteByteMask(0x101e6e, 0, BIT7);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6d, 0, BIT0);
    MDrv_WriteByteMask(0x101e6f, 0, BIT0);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6d, 0, BIT1);
    MDrv_WriteByteMask(0x101e6f, 0, BIT1);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6d, 0, BIT2);
    MDrv_WriteByteMask(0x101e6f, 0, BIT2);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6d, 0, BIT3);
    MDrv_WriteByteMask(0x101e6f, 0, BIT3);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6d, 0, BIT4);
    MDrv_WriteByteMask(0x101e6f, 0, BIT4);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e05, 0, BIT1|BIT0 );   //reg[101e05]#1~#0 = 00b
    //reg_fourthuartmode = 0b
    MDrv_WriteByteMask(0x101e04, 0, BIT6 );   //reg[101e04]#6 = 0b


    MDrv_WriteByteMask(0x101e6d, 0, BIT5);
    MDrv_WriteByteMask(0x101e6f, 0, BIT5);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6d, 0, BIT6);
    MDrv_WriteByteMask(0x101e6f, 0, BIT6);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e6d, 0, BIT7);
    MDrv_WriteByteMask(0x101e6f, 0, BIT7);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101ec8, 0, BIT5 );   //reg[101ec8]#5 = 00b


    MDrv_WriteByteMask(0x101e72, 0, BIT0);
    MDrv_WriteByteMask(0x101e74, 0, BIT0);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e72, 0, BIT1);
    MDrv_WriteByteMask(0x101e74, 0, BIT1);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e72, 0, BIT2);
    MDrv_WriteByteMask(0x101e74, 0, BIT2);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e72, 0, BIT3);
    MDrv_WriteByteMask(0x101e74, 0, BIT3);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e72, 0, BIT4);
    MDrv_WriteByteMask(0x101e74, 0, BIT4);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e72, 0, BIT5);
    MDrv_WriteByteMask(0x101e74, 0, BIT5);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e72, 0, BIT6);
    MDrv_WriteByteMask(0x101e74, 0, BIT6);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e72, 0, BIT7);
    MDrv_WriteByteMask(0x101e74, 0, BIT7);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e73, 0, BIT1);
    MDrv_WriteByteMask(0x101e75, 0, BIT1);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e73, 0, BIT2);
    MDrv_WriteByteMask(0x101e75, 0, BIT2);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e73, 0, BIT3);
    MDrv_WriteByteMask(0x101e75, 0, BIT3);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e73, 0, BIT4);
    MDrv_WriteByteMask(0x101e75, 0, BIT4);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e73, 0, BIT5);
    MDrv_WriteByteMask(0x101e75, 0, BIT5);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e73, 0, BIT6);
    MDrv_WriteByteMask(0x101e75, 0, BIT6);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e73, 0, BIT7);
    MDrv_WriteByteMask(0x101e75, 0, BIT7);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101ea5, 0, BIT2);
    MDrv_WriteByteMask(0x101ea5, 0, BIT4);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
    ...
    MDrv_WriteByteMask(0x101e96, 0, BIT0);
    MDrv_WriteByteMask(0x101e98, 0, BIT0);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    //reg_ddcdc[7:6] = 00b
    //reg_ts0config[2:0] = 0b
    MDrv_WriteByteMask(0x101eaf, 0, BIT4|BIT3|BIT2 );   //reg[101eaf]#4~#2 = 00b
    //reg_ts_out_mode[5:4] = 00b
    MDrv_WriteByteMask(0x101eaa, 0, BIT5|BIT4 );   //reg[101eaa]#5~#4 = 00b


    MDrv_WriteByteMask(0x101e96, 0, BIT1);
    MDrv_WriteByteMask(0x101e98, 0, BIT1);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 0b
    MDrv_WriteByteMask(0x101e13, 0, BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 00b
    //reg_ddcdc[7:6] = 00b
    //reg_ts0config[2:0] = 0b
    MDrv_WriteByteMask(0x101eaf, 0, BIT4|BIT3|BIT2 );   //reg[101eaf]#4~#2 = 00b
    //reg_ts_out_mode[5:4] = 00b
    ...
    MDrv_WriteByteMask(0x101e96, 0, BIT2);
    MDrv_WriteByteMask(0x101e98, 0, BIT2);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e96, 0, BIT3);
    MDrv_WriteByteMask(0x101e98, 0, BIT3);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e96, 0, BIT4);
    MDrv_WriteByteMask(0x101e98, 0, BIT4);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e96, 0, BIT5);
    MDrv_WriteByteMask(0x101e98, 0, BIT5);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e96, 0, BIT6);
    MDrv_WriteByteMask(0x101e98, 0, BIT6);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e96, 0, BIT7);
    MDrv_WriteByteMask(0x101e98, 0, BIT7);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e97, 0, BIT0);
    MDrv_WriteByteMask(0x101e99, 0, BIT0);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e97, 0, BIT1);
    MDrv_WriteByteMask(0x101e99, 0, BIT1);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e97, 0, BIT2);
    MDrv_WriteByteMask(0x101e99, 0, BIT2);
    //reg_ts0_pe[7:0] = ffh
    MDrv_WriteByteMask(0x101e12, 0xff, 0xff );   //reg[101e12]#7~#0 = ffh
    //reg_ts0_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101e13, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101e13]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e52, 0, BIT0);
    MDrv_WriteByteMask(0x101e54, 0, BIT0);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    //reg_ts1config[2:0] = 0b
    MDrv_WriteByteMask(0x101eaf, 0, BIT4|BIT3|BIT2 );   //reg[101eaf]#4~#2 = 00b
    //reg_ts_out_mode[7:6] = 00b
    MDrv_WriteByteMask(0x101eaa, 0, BIT7|BIT6 );   //reg[101eaa]#7~#6 = 00b


    MDrv_WriteByteMask(0x101e52, 0, BIT1);
    MDrv_WriteByteMask(0x101e54, 0, BIT1);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e52, 0, BIT2);
    MDrv_WriteByteMask(0x101e54, 0, BIT2);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e52, 0, BIT3);
    MDrv_WriteByteMask(0x101e54, 0, BIT3);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e52, 0, BIT4);
    MDrv_WriteByteMask(0x101e54, 0, BIT4);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e52, 0, BIT5);
    MDrv_WriteByteMask(0x101e54, 0, BIT5);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e52, 0, BIT6);
    MDrv_WriteByteMask(0x101e54, 0, BIT6);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e52, 0, BIT7);
    MDrv_WriteByteMask(0x101e54, 0, BIT7);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e55, 0, BIT0);
    MDrv_WriteByteMask(0x101e51, 0, BIT0);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e55, 0, BIT1);
    MDrv_WriteByteMask(0x101e51, 0, BIT1);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e55, 0, BIT2);
    MDrv_WriteByteMask(0x101e51, 0, BIT2);
    //reg_ts1_pe[7:0] = ffb
    MDrv_WriteByteMask(0x101efc, 0xff, 0xff );   //reg[101efc]#7~#0 = ffh
    //reg_ts1_pe[10:8] = 111b
    MDrv_WriteByteMask(0x101efd, BIT2|BIT1|BIT0 , BIT2|BIT1|BIT0 );   //reg[101efd]#2~#0 = 111b
    ...
    MDrv_WriteByteMask(0x101e73, 0, BIT0);
    MDrv_WriteByteMask(0x101e75, 0, BIT0);
    //reg_pcm_pe[33:0] = 3ffffh
    MDrv_WriteByteMask(0x101e0c, 0xff, 0xff );   //reg[101e0c]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0d, 0xff, 0xff );   //reg[101e0d]#7 ~#0 = ffh
    MDrv_WriteByteMask(0x101e0e, 0xff, 0xff );   //reg[101e0e]#7 ~#0 = ffh
...
{
    //printf("=> StandBy \n");
    printf("MDrv_Power_StandbyPowerOff()\n");
