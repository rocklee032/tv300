...
//Melody: 128 pin
#if ( (MS_BOARD_TYPE_SEL == BD_MST242B_D01A_S) \
    || (MS_BOARD_TYPE_SEL == BD_MST096B_10ARU_15384) \
    || (MS_BOARD_TYPE_SEL == BD_MST106B_10ARU_16115_ISDB_MELODY) \
    || (MS_BOARD_TYPE_SEL == BD_MST143B_10ARU_17474))
