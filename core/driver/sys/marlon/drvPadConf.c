...
//---------------------------------------------------------------------
    ...
    _RVM1(0x1aee, BIT3|BIT2|BIT1|BIT0, BIT3|BIT2|BIT1|BIT0 ),   //reg[121aee]#3~#0 = fh
    #endif
...
#define SPDIFOUT_CFG2  ((PADS_SPDIF_OUT == SPDIF_OUT_MODE(4)) ? BIT5 : \
                                    (PADS_SPDIF_OUT == SPDIF_OUT_MODE(4)) ? BIT5 : 0)
            _RVM1(0x1E3F, SPDIFOUT_CFG2, BIT5), //reg_chiptop_dummy_3
#endif
