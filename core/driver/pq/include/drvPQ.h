...
#ifndef ENABLE_PQ_BIN_TEXT
    #define ENABLE_PQ_BIN_TEXT  (0 && ENABLE_PQ_BIN)
#endif

#ifndef ENABLE_PQ_BIN_EX
    #define ENABLE_PQ_BIN_EX    (0 && ENABLE_PQ_BIN)
#endif

//---------------------------------------------------------------------------------------------------

#define PQ_FILE_MAIN    0
#define PQ_FILE_MAIN_EX 1
#define PQ_FILE_SUB     2
#define PQ_FILE_SUB_EX  3
