...
#define PQ_IP_LinearRGB_DE_GAMMA_SRAM_SIZE_Main 1202
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_24hz_MPEG2_Main, //101
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_MPEG2_Main, //102
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_MPEG2_Main, //103
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_MPEG2_Main, //104
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_MPEG2_Main, //105
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_MPEG2_Main, //106
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_MPEG2_Main, //107
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_MPEG2_Main, //108
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_MPEG2_Main, //109
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_MPEG2_Main, //110
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_H264_Main, //111
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_H264_Main, //112
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_H264_Main, //113
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_H264_Main, //114
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_24hz_H264_Main, //115
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_H264_Main, //116
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_H264_Main, //117
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_H264_Main, //118
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_H264_Main, //119
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_H264_Main, //120
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_H264_Main, //121
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_H264_Main, //122
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_H264_Main, //123
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_H264_Main, //124
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_H265_Main, //125
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_H265_Main, //126
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Main, //127
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Main, //128
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Main, //129
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Main, //130
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Main, //131
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Main, //132
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Main, //133
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Main, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_interlace_Main, //135
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_Main, //136
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_SD_progressive_24hz_Main, //137
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_interlace_Main, //138
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_Main, //139
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_online_HD_progressive_24hz_Main, //140
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Main, //141
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Main, //142
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Main, //143
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Main, //144
    #endif
    #if PQ_QM_3D
    QM_3D_Video_interlace_Main, //145
    #endif
    #if PQ_QM_3D
    QM_3D_Video_progressive_Main, //146
    #endif
    QM_INPUTTYPE_NUM_Main, // 147
...
PQ_IP_MADi_P_MODE8_NO_DNR_Main,
