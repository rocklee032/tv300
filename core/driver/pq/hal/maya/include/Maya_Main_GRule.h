...
#if (PQ_GRULE_NR_ENABLE) || (PQ_GRULE_OSD_BW_ENABLE) || (PQ_GRULE_MPEG_NR_ENABLE) || (PQ_GRULE_FILM_MODE_ENABLE) || (PQ_GRULE_DYNAMIC_CONTRAST_ENABLE) || (PQ_GRULE_COLOR_FOR_VIVID_ENABLE) || (PQ_GRULE_PTP_ENABLE) || (PQ_GRULE_GAME_MODE_ENABLE)
typedef enum
{
...
#define PQ_GRULE_RULE_NUM_Main 8
