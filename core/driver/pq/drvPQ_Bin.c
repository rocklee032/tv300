...
#if(ENABLE_PQ_BIN_EX)
void MDrv_PQBin_Ex_SetPanelID(MS_U8 u8PnlIDx)
{
    _gPQBinEx_PnlIdx = u8PnlIDx;
}

MS_U8 MDrv_PQBin_Ex_GetPanelIdx(void)
{
    return _gPQBinEx_PnlIdx;
}
#endif
