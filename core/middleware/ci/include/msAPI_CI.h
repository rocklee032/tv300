...
#define CC_URI_RL_MULTIPLES_OF_24HOURS_APPLIES_END_FOR_CC_V2    0xFE
...
#define CC_LICENSE_EXCHANGE_TIMEOUT 9000 // 9s
...
//*****************************************************************************
///msAPI_CI_SetHssSuspend
/// Description
///   Set HSS Suspend
/// @return void:
void msAPI_CI_SetHssSuspend(U32 u32Timeout);
...
//*****************************************************************************
///msAPI_CI_EnableReTriggerURI
/// Description
///   ReTriggert URI When Same CA_PMT
/// @param bRet              \b IN: Enable/Disable
/// @return: void
//*****************************************************************************
void msAPI_CI_EnableReTriggerURI(BOOL bRet);
...
U16 msAPI_CI_CC_GetUriValue(CI_CC_URI_LICENSE pstUriLicense, EN_URI_MESSAGE enUriMsg);
/*********************************************************/
