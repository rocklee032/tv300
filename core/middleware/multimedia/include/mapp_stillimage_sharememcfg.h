...
#define STILLIMAGE_SHAREMEM_VERSION_NUM     0x0000000O // 00.000.00O
#define STILLIMAGE_SHAREMEM_MAGICKEY        (0x5A5AA5A5)

//size of ST_STILLIMAGE_JPEG_EXIF: 8*6+4+32+128+4+4+4=224, 224/4=56,  define 64 for future extension use
#define E_STILLIMAGE_SHAREMEM_OUTPUT_JPEG_EXIF_DATASIZE  (64)
//size of ST_STILLIMAGE_JPEG_EXIF_GPS: 4+(2+2)+4+(3*8)+(3*8)+8=68, 68/4=17, define 20 for future extension use
#define E_STILLIMAGE_SHAREMEM_OUTPUT_JPEG_EXIF_GPS_DATASIZE  (32)

//#define STILLIMAGE_MEM_MIU1_USED      (0x20000000UL)

#define EXIF_CAMERA_MAKER_SIZE  32
#define EXIF_CAMERA_MODEL_SIZE  128
#define EXIF_GPS_VERSION_ID_SIZE 4
#define EXIF_GPS_LATITUDE_REF_SIZE 2
#define EXIF_GPS_LATITUDE_SIZE 6
#define EXIF_GPS_LONGITUDE_REF_SIZE 2
#define EXIF_GPS_LONGITUDE_SIZE 6
#define EXIF_GPS_ALTITUDE_SIZE 2
...
typedef enum
{
    ...
    ****************************************/
    ...
    //jpeg exif data, ref ST_STILLIMAGE_JPEG_EXIF_GPS
    E_STILLIMAGE_SHAREMEM_OUTPUT_JPEG_EXIF_DATA_GPS,
    E_STILLIMAGE_SHAREMEM_OUTPUT_JPEG_EXIF_DATA_GPS_END = E_STILLIMAGE_SHAREMEM_OUTPUT_JPEG_EXIF_DATA_GPS + E_STILLIMAGE_SHAREMEM_OUTPUT_JPEG_EXIF_GPS_DATASIZE,
...
typedef struct
{
    ...
    unsigned long u32ColorSpace;
}ST_STILLIMAGE_JPEG_EXIF;

typedef struct
{
    unsigned char au8GpsVersionID[EXIF_GPS_VERSION_ID_SIZE];
    unsigned char au8GpsLatitudeRef[EXIF_GPS_LATITUDE_REF_SIZE];
    unsigned char au8GpsLongitudeRef[EXIF_GPS_LONGITUDE_REF_SIZE];
    unsigned char u8GpsAltitudeRef;
    unsigned long au32GpsLatitude[EXIF_GPS_LATITUDE_SIZE];
    unsigned long au32GpsLongitude[EXIF_GPS_LONGITUDE_SIZE];
    unsigned long au32GpsAltitude[EXIF_GPS_ALTITUDE_SIZE];
}ST_STILLIMAGE_JPEG_EXIF_GPS;
