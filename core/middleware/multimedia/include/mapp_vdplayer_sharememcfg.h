...
#define SHAREMEM_VERSION_NUM 200205
...
typedef enum
{
    ...
    E_SHAREMEM_VIDEO_PID,                           // 0x39f
    E_SHAREMEM_AUDIO_PID,                           // 0x3a0
...
typedef enum
{
    ...
    E_SHAREMEM_EXT_ENABLE_VSYNC_CTRL,                   // HK -> Co-processor   0x1F
    E_SHAREMEM_EXT_DISP_WIN_ID,                         // HK -> Co-processor   0x20
...
typedef enum
{
    ...
    // Attribute for specific config header
    E_VDP_CODEC_SPECIFIC_CONFIG           = 0x0020,
    ...
    E_VDP_CODEC_ID_VIDEO_SPECIFIC_CONFIG  = E_VDP_CODEC_ID_SUPPORT_VIDEO + E_VDP_CODEC_SPECIFIC_CONFIG,
    ...
    E_VDP_CODEC_ID_AUDIO_SPECIFIC_CONFIG  = E_VDP_CODEC_ID_SUPPORT_AUDIO + E_VDP_CODEC_SPECIFIC_CONFIG,
    ...
    E_VDP_CODEC_ID_OPUS                = E_VDP_CODEC_ID_SUPPORT_AUDIO + E_VDP_CODEC_OPUS,
...
// MM -> HK Command (Register PipeLine)
#define MB_VDPLAYER_GET_NEXT_SEGMENT                0xE6
...
typedef enum
{
    ...
    /// encrypt type
    E_VDP_ENCRYPT_TYPE_NSTV_DRM         = 0x00010000,
