...
typedef struct
{
    ...
    U32 bEnableNITQuickScan:        1;
    U32 bEnableBATParse:            1;
    U32 reserved:                   11;
}SCAN_TABLE_CONFIG;
...
INTERFACE void MApp_Dmx_EIT_FileIn_Cur_PF_Cb(U8 u8FID, U32 enEvent);
INTERFACE void MApp_Dmx_EIT_FileIn_Cur_PF_Monitor(void);
