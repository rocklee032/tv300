...
typedef enum
{
    ...
    SI_COUNTRY_TAJIKISTAN,
    SI_COUNTRY_KYRGYZSTAN,
    SI_COUNTRY_UZBEKISTAN, //60
    SI_COUNTRY_KAZAKHSTAN,
    SI_COUNTRY_PAKISTAN,
    SI_COUNTRY_INDIA,
    SI_COUNTRY_JORDAN,
    SI_COUNTRY_IRAQ,
    SI_COUNTRY_AFGHANISTAN,
    SI_COUNTRY_PHILIPPINES,
    SI_COUNTRY_PERU,
    SI_COUNTRY_ARGENTINA,
    SI_COUNTRY_CHILE,
    SI_COUNTRY_VENEZUELA,
    SI_COUNTRY_ECUADOR,
    SI_COUNTRY_PARAGUAY,
    SI_COUNTRY_COSTARICA,
    SI_COUNTRY_BOLIVIA,
    SI_COUNTRY_NICARAGUA,
    SI_COUNTRY_URUGUAY,
    SI_COUNTRY_BELIZE,
    SI_COUNTRY_HONDURAS,
    SI_COUNTRY_GUATEMAL,
...
//use for ENABLE_BAT_SCAN and ENABLE_BAT_MONITOR
typedef enum
{
    SI_REGION_MIN = 0x0001,
    SI_REGION_NETHERLANDS = SI_REGION_MIN,
    SI_REGION_AUCKLAND = 0x1000,
...
typedef enum
{
    ...
    SI_RUN_UNDEFINED_SPECIFIC_COUNTRY=47,
    EPG_EVENT_OVERLAP_SPECIFIC_COUNTRY=48,
    SI_SUMSUNG_SPECIFIC_COUNTRY=49,
...
typedef enum _EN_SI_MENU_LANGUAGE
{
    ...
    SI_LANGUAGE_TAMIL,
    //TKL-7Mar2014-2<<<
    SI_LANGUAGE_AD_PREMIX,       // Thai version3 spec
...
typedef enum _EN_SI_TIMEZONE
{
    ...
    SI_TIMEZONE_UKRAINE,
    SI_TIMEZONE_GMT_2_END=SI_TIMEZONE_UKRAINE,
    ...
    SI_TIMEZONE_DUSHANBE,
    SI_TIMEZONE_TASHKENT,
    SI_TIMEZONE_KABUL,
    SI_TIMEZONE_ISLAMABAD,
    SI_TIMEZONE_GMT_5_END=SI_TIMEZONE_ISLAMABAD,
...
//ISDBT_SOUTH_AMERICA_TIMEZONE_LIST
//GMT - 6
    SI_TIMEZONE_GMT_Minus6_START,
    SI_TIMEZONE_ECUADOR=SI_TIMEZONE_GMT_Minus6_START,
    SI_TIMEZONE_COSTARICA,
    SI_TIMEZONE_NICARAGUA,
    SI_TIMEZONE_BELIZE,
    SI_TIMEZONE_HONDURAS,
    SI_TIMEZONE_GUATEMAL,
    SI_TIMEZONE_ISLAS_GALAPAGOS,
    SI_TIMEZONE_GMT_Minus6_END=SI_TIMEZONE_ISLAS_GALAPAGOS,

    //GMT - 5
    SI_TIMEZONE_GMT_Minus5_START,
    SI_TIMEZONE_AM_WEST=SI_TIMEZONE_GMT_Minus5_START,
    SI_TIMEZONE_COLOMBIA,
    SI_TIMEZONE_ACRE,
    SI_TIMEZONE_GMT_Minus5_END=SI_TIMEZONE_ACRE,
//ISDBT_SOUTH_AMERICA_TIMEZONE_LIST
//GMT - 4.5
    SI_TIMEZONE_GMT_Minus4Point5_START,
    SI_TIMEZONE_VENEZUELA=SI_TIMEZONE_GMT_Minus4Point5_START,
    SI_TIMEZONE_CARACAS,
    SI_TIMEZONE_GMT_Minus4Point5_END=SI_TIMEZONE_CARACAS,
...
INTERFACE U16 msAPI_SI_GetPhysicalChannelNumberByID(WORD wONID, WORD wTSID);
...
INTERFACE U16 msAPI_SI_RemoveMismatchedProgram(U16 u16RFChannelNumber, U16 wTS_ID, U8 u8PLP_ID,U8 u8HpLp,  U16 *pwService_ID, MEMBER_SI_SERVICETYPE *peService_Type, WORD cCountOfServiceID);
...
INTERFACE BOOLEAN msAPI_SI_IsZiggo_Spec_Country(EN_SI_COUNTRY_SETTING eCountry);
