...
TT_BOOL _LoadFont(void)
{
    ...
    TT_DriverIntRamMemset ((void *)msOS_NonCacheToCache(tmpAddr1), 0, WORKING_FONT_BUFFER_SIZE);

    //TT_DriverIntRamMemset ((void *)(tmpAddr2 & NON_CACHEABLE_TO_CACHEABLE_MASK), 0, WORKING_FONT_BUFFER_SIZE);
    TT_DriverIntRamMemset ((void *)msOS_NonCacheToCache(tmpAddr2), 0, WORKING_FONT_BUFFER_SIZE);
