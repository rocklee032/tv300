...
void msAPI_CC_SetSysBuffer(void)
{
    ...
    u32CC608RbAddr = ((CC608MVD_RINGBUFFER_START_MEMORY_TYPE & MIU1) ? (CC608MVD_RINGBUFFER_START_ADR | MIU_INTERVAL) : (CC608MVD_RINGBUFFER_START_ADR));
    ...
    u32CC708RbAddr = ((CC708MVD_RINGBUFFER_START_MEMORY_TYPE & MIU1) ? (CC708MVD_RINGBUFFER_START_ADR | MIU_INTERVAL) : (CC708MVD_RINGBUFFER_START_ADR));
...
void msAPI_CC_SetOsdSetting(stCaptionSetting_Type * pCaptionOSDSetting)
{
   ...
   g_fCCAttrFlag.fCCAttr_Support_WordWrap_Flag = CC_CONFIG_fCCAttr_Support_WordWrap;
    ...
    g_fCCAttrFlag.fCCAttr_Check_Command_Length  = CC_CONFIG_fCCAttr_CheckCmdLength;
    g_fCCAttrFlag.fCCAttr_NotStandard_Stream_Adaptation = CC_CONFIG_fCCAttr_NotStandardStreamAdaptation;
...
void msAPI_CC_SetMisInfo(U8 u8Mode)
{
    ...
    */
    ...
    if (u8Mode == SYSINFO_MODE_708)
    {
        ...
        CC_DecoderFuns.Timeout_Threshold708(g_u32708CaptionTimeout);
