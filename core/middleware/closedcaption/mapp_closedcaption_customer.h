...
#define CC_CONFIG_fCCAttr_Show_Window_Has_Text   TRUE
#define CC_CONFIG_fCCAttr_EnableWindowOptionSetting  FALSE
#define CC_CONFIG_fCCAttr_Support_Deep_Color   TRUE       //TRUE: 64 color palette; FALSE: 8 color palette
...
#define CC_CONFIG_fCCAttr_Support_WordWrap TRUE
#define CC_CONFIG_fCCAttr_CheckCmdLength TRUE
#define CC_CONFIG_fCCAttr_NotStandardStreamAdaptation TRUE
