...
INTERFACE BOOLEAN MApp_EIT_CheckUTCbyCurPresentEvent(U32 u32TDTtime,U32 u32TOTtime);
...
INTERFACE void MApp_EIT_FileInCur_PF_Parse(U8 pu8Section[], U8* pu8FirstSectionNo, U8* pu8LastSectionNo, U8* ver);
INTERFACE U8 MApp_EITFileIn_GetCurParentControl(void);
INTERFACE BOOLEAN MApp_EIT_FileInFreeCurPFInfo(void);
