...
#define MSIF_EPG_LIBVER            {'2','5'}                            //LIB version
#define MSIF_EPG_BUILDNUM          {'0','0'}                            //Build Number
#define MSIF_EPG_CHANGELIST        {'@','e','7','c','1','3','6','2'}     //P4 ChangeList Number
...
INTERFACE void MApp_EPG_SetMinEventDuration(U8 u8MinEventDuration);
#if(MHEG5_SIINFO_ENABLE)
/**
