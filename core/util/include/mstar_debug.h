...
INTERFACE U32 g_Debug_u32Time_VDEC_WritePTR; // ES Buffer

INTERFACE U32 g_Debug_u32Time_VDEC_CheckDispInfoRdy;
INTERFACE U32 g_Debug_u32Time_VDEC_IsWithValidStream;
INTERFACE U32 g_Debug_u32Time_VDEC_GetDispInfo;
...
void* MIPS_Get_PC(void);
void* MIPS_Get_SP(void);
void* MIPS_Get_RA(void);

// This function is only use at NON-ISR function!!
#define MIPS_BT_NonISR()    do{ \
    if( g_MIPS_u8BTCount++ < 1) \
...
#if defined(__mips__)
    #define msDebug_Backtrace_NonISR()  MIPS_BT_NonISR()
#elif( defined(__arm__) )

#elif( defined(__AEONR2__) )
  #if( ENABLE_R2_BACKTRACE )
    #define msDebug_Backtrace_NonISR()  r2_online_bt()
  #endif
#endif
