...
/*const*/ DTVPROGRAMID_M* msAPI_DtvDB_Get_ProgIdTable(TypDtvDbSel eDtvDbSel);
#define msAPI_DtvDB_Get_ProgIdTable_ReadOnly(db) (const DTVPROGRAMID_M*)msAPI_DtvDB_Get_ProgIdTable((db))
#define msAPI_DtvDB_Get_ProgIdTable_RW(db)       (      DTVPROGRAMID_M*)msAPI_DtvDB_Get_ProgIdTable((db))
