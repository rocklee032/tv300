...
/*const*/ DTVPROGRAMID_M* msAPI_DtvDB_Get_ProgIdTable(TypDtvDbSel eCurDbSel)
{
...
BOOLEAN msAPI_DtvDB_Save_IDTable(TypDtvDbSel eDtvDbSel, DTVPROGRAMID_M* pstIDTable, U16 u16ArraySize )
{
    U16 u16IDTableArraySize = msAPI_DtvDB_Get_ProgIdTableArraySize(eDtvDbSel);
    U32 u32IDTableRamDiskAddr = msAPI_DtvDB_Get_ProgIdTableRamDiskAddr(eDtvDbSel);
    ...
    SetNVRAM(u32IDTableRamDiskAddr, (U8*)pstIDTable, u16ArraySize * sizeof(DTVPROGRAMID_M) );
