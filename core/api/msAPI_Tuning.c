...
TUNING_STATUS _GetTuningStatus(void)
{
    ...
    #include "msAPI_Tuning_BRAZIL.c"
    #define _msAPI_Tuner_TuningProcessor(x)
    #define _msAPI_Tuner_GetTuningProcessPercent(x) 0
    #else
...
{
    U8 u8MinChannel = CHANNEL_NUMBER_MIN_DEFAULT, u8MaxChannel = CHANNEL_NUMBER_MAX_DEFAULT;
...
#if (ENABLE_ATSC || (AUTO_TUNING_TYPE_SEL == AUTO_TUNING_ALG_NTSC))
