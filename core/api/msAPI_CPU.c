...
void msAPI_COPRO_Init(MS_U16 u16BinID, MS_U32 u32_ADR, MS_U32 u32_LEN)
{
    ...
    if(g_bMHEG5BinBootSkip == TRUE)
    {
        BOOLEAN bMHEG5BinSTRRecover = FALSE;
        bMHEG5BinSTRRecover = MAPP_MHEG5_STRRecover(u32_ADR);
        if(bMHEG5BinSTRRecover == FALSE)
        {
