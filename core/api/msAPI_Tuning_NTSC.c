...
#define SPEEDUP_NTSC_ATV_SCAN       ENABLE

#define SCAN_PLL_STEP_START         0
#define SCAN_PLL_STEP_PLUS_1MHZ     1
#define SCAN_PLL_STEP_PLUS_1p5MHZ   2
#define SCAN_PLL_STEP_MINUS_1MHZ    3
#define SCAN_PLL_STEP_MINUS_1p5MHZ  4

#ifndef SUPPORT_AFT_RANGE_2M
#define SUPPORT_AFT_RANGE_2M        DISABLE
#endif

#define RANGE_SCAN_PLUS_PLL         TUNER_PLL_PLUS_1p5MHz
#define RANGE_SCAN_MINUS_PLL        TUNER_PLL_MINUS_1p5MHz

U8 _u8NumberOfChFound_WhileAutoScan;

static void _msAPI_NTSC_AutoFineTuning(AFC eFreqDev)
{
    ...
    if ( DIFFERENCE(_u16RealtimeAFTBaseTunerPLL,_u16TunerPLL) <= TUNER_PLL_PLUS_2MHz && msAPI_AVD_IsSyncLocked() == TRUE )
    {
        ...
        // for ( i = 0; i <= TUNER_PLL_PLUS_4MHz ; i++ )
        {
            switch ( eFreqDev )
            {
                case E_AFC_BELOW_MINUS_187p5KHz:    u16AftPLL = PLLSTEP(TUNER_PLL_PLUS_187p5KHz);  break;
                case E_AFC_MINUS_162p5KHz:          u16AftPLL = PLLSTEP(TUNER_PLL_PLUS_162p5KHz);  break;
                case E_AFC_MINUS_137p5KHz:          u16AftPLL = PLLSTEP(TUNER_PLL_PLUS_137p5KHz);  break;
                case E_AFC_MINUS_112p5KHz:          u16AftPLL = PLLSTEP(TUNER_PLL_PLUS_112p5KHz);  break;
                case E_AFC_MINUS_87p5KHz:           u16AftPLL = PLLSTEP(TUNER_PLL_PLUS_87p5KHz);  break;
                case E_AFC_MINUS_62p5KHz:           u16AftPLL = PLLSTEP(TUNER_PLL_PLUS_62p5KHz);  break;
                case E_AFC_MINUS_37p5KHz:           u16AftPLL = PLLSTEP(TUNER_PLL_PLUS_37p5KHz);  break;
                case E_AFC_MINUS_12p5KHz:           return;
                case E_AFC_PLUS_12p5KHz:            return;
                case E_AFC_PLUS_37p5KHz:            u16AftPLL = PLLSTEP(TUNER_PLL_MINUS_37p5KHz); break;
                case E_AFC_PLUS_62p5KHz:            u16AftPLL = PLLSTEP(TUNER_PLL_MINUS_62p5KHz); break;
                case E_AFC_PLUS_87p5KHz:            u16AftPLL = PLLSTEP(TUNER_PLL_MINUS_87p5KHz); break;
                case E_AFC_PLUS_112p5KHz:           u16AftPLL = PLLSTEP(TUNER_PLL_MINUS_112p5KHz); break;
                case E_AFC_PLUS_137p5KHz:           u16AftPLL = PLLSTEP(TUNER_PLL_MINUS_137p5KHz); break;
                case E_AFC_PLUS_162p5KHz:           u16AftPLL = PLLSTEP(TUNER_PLL_MINUS_162p5KHz); break;
                case E_AFC_ABOVE_PLUS_187p5KHz:     u16AftPLL = PLLSTEP(TUNER_PLL_MINUS_187p5KHz); break;
                default:
                    u16AftPLL = _u16RealtimeAFTBaseTunerPLL;
                    break;
            }
            if(u16AftPLL != _u16TunerPLL)
            {
    ...
    switch ( _eCurrentTuningState )
    {
        ...
        case AFT_IDLE:
                ...
                if ( (_u16AFTIdleTimer % 19) == 0 )
                {
                    ...
                    _msAPI_NTSC_AutoFineTuning(MDrv_IFDM_GetFreqDev());
                }
                return;
        ...
        case AFT_EXT_STEP_SEARCHONECH:
                ...
                bFirstDetect = FALSE;
                _u8NumberOfChFound_WhileAutoScan = 0;
                u8StatusTemp = 0;
                _eCurrentTuningState = AFT_CHECKSYNC;

                break;

#if (SPEEDUP_NTSC_ATV_SCAN == DISABLE)
            case AFT_CHECKSYNC:
        ...
        case AFT_DETECTVIDEO:
                ...
                bIsSignalExist = TRUE;
                u8VideoStableCount = 0;
                _u8NumberOfChFound_WhileAutoScan++;
                _eCurrentTuningState = AFT_MEMORIZEPRDATA;
                ...
                if (bVD_Check || (msAPI_Timer_DiffTimeFromNow(u32StatusWaitTime)) > ATVSCAN_VIFLOCK_TOTAL_CHECK_TIME)
                {
                    ...
                    switch(u8ScanPllStep)
                    {
                        ...
                        case SCAN_PLL_STEP_PLUS_1MHZ:
                            u8ScanPllStep = SCAN_PLL_STEP_PLUS_1p5MHZ;
                            _SetTunerPLL(u16PreviosTunerPLL + TUNER_PLL_PLUS_1p5MHz);
                            _u16TuningWaitTimer = 5;
                            u32StatusWaitTime = msAPI_Timer_GetTime0();
                            break;

                        case SCAN_PLL_STEP_PLUS_1p5MHZ:
                        ...
                        case SCAN_PLL_STEP_MINUS_1MHZ:
                            u8ScanPllStep = SCAN_PLL_STEP_MINUS_1p5MHZ;
                            _SetTunerPLL(u16PreviosTunerPLL + TUNER_PLL_MINUS_1p5MHz);
                            _u16TuningWaitTimer = 5;
                            u32StatusWaitTime = msAPI_Timer_GetTime0();
                            break;

                        case SCAN_PLL_STEP_MINUS_1p5MHZ:
                            _u16TunerPLL = u16PreviosTunerPLL;
                            _eCurrentTuningState = AFT_MEMORIZEPRDATA;
                            break;
        ...
        case AFT_COMPLETE:
                ...
                if(_u8NumberOfChFound_WhileAutoScan == 0)
                {
