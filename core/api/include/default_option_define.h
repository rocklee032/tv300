...
#ifndef ENABLE_FileInMonitor
    #define ENABLE_FileInMonitor  DISABLE         //PAT PMT EIT
#endif
...
#ifndef ISDB_DEFAULT_COUNTRY
    #define ISDB_DEFAULT_COUNTRY                   E_BRAZIL //E_PHILIPPINES //E_BRAZIL
#endif
...
#ifndef ENABLE_TNT_LCN
    #define ENABLE_TNT_LCN DISABLE
#endif
...
#ifndef ENABLE_RCSRDS_C
    #define ENABLE_RCSRDS_C DISABLE
#endif
...
#if(STR_ENABLE&&CHIP_SUPPORT_STR)
  #if( CHIP_FAMILY_MARLON2 == CHIP_FAMILY_TYPE )
    #define ENABLE_STR_PQ_PATCH     0
    #define ENABLE_STR_AUDIO_PATCH  0
    #define ENABLE_STR_FONT_PATCH   0
    #define ENABLE_STR_MHEG5_BIN_PATCH   0
  #else
    #define ENABLE_STR_PQ_PATCH     1
    #define ENABLE_STR_AUDIO_PATCH  1
    #define ENABLE_STR_FONT_PATCH   1
    #define ENABLE_STR_MHEG5_BIN_PATCH   1
  #endif
#else
    #define ENABLE_STR_PQ_PATCH     0
    #define ENABLE_STR_AUDIO_PATCH  0
...
#ifndef ENABLE_TUNER_CLK_EXT
    #define ENABLE_TUNER_CLK_EXT    DISABLE
#endif
