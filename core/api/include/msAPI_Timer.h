...
#define DEBUG_RTC(x)        //do { msDebug_ANSI_SetColorText(E_FONT_BACKGROUND_COLOR_RED); x; msDebug_ANSI_AllAttrOffText(); } while(0)
...
INTERFACE U32 msAPI_Timer_DiffTimeFromNow_2(U32 u32TaskTimer);
...
INTERFACE U32 msAPI_PiuTimer_GetTime0(void);
INTERFACE U32 msAPI_PiuTimer_DiffTimeFromNow(U32 u32TaskTimer);
...
typedef enum
{
    ...
    E_DELAY_ID_AUDIO_DRV_SET_MUTE           = 23, // MApi_AUDIO_SetMute


    E_DELAY_ID_AUDIO_API            = 30,
    E_DELAY_ID_AUDIO_API_SOUND_MODE = 31,
...
INTERFACE void msAPI_Timer_Delayus(U32 u32DelayTime); //unit = us
