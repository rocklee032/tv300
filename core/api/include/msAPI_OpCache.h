...
/// Invalid op cachec index
#define INVALID_OPCACHE_INDEX  0xFF
...
/// @return             \b  return TRUE : success or FALSE : failure
// -----------------------------------------------------------
INTERFACE BOOLEAN msAPI_OP_UpdateCIOpInfo(const CI_OP_INFO *stCiOpInfo, U8 u8ProfileType);
...
INTERFACE U8 msAPI_OP_GetOpCacheIndexByCicamId(U32 u32CicamId);
INTERFACE BOOLEAN msAPI_OP_CheckOpCacheInfo(void);
#endif
