...
#define msAPI_PVR_GetTime0              msAPI_PiuTimer_GetTime0
#define msAPI_PVR_DiffTimeFromNow       msAPI_PiuTimer_DiffTimeFromNow
...
typedef enum
{
    E_PVR_PACKET_188         = 188,
    E_PVR_PACKET_192         = 192,
} enPvrPacketSize;
...
INTERFACE enPvrApiStatus msAPI_PVR_PlaybackPathJumpToTime(_msAPI_PVR_PlaybackPath * pstPvrPlaybackPath, U32 u16JumpSecond);
...
INTERFACE U32 msAPI_PVR_PlaybackGetStartTimeStamp(enPvrEncryptType enEncryptionType, U8 u8FileHandle);
INTERFACE U32 msAPI_PVR_GetFileStartTimeStamp(void);
INTERFACE U32 msAPI_PVR_GetFileEndTimeStamp(void);
#endif
...
INTERFACE BOOL msAPI_PVR_GetMeataDataLockInfo(void);
INTERFACE BOOL msAPI_PVR_GetMeataDataParentalControl(void);

INTERFACE void msAPI_PVR_SetRetentionLimitJumpBackward(BOOL bRetentionLimitJump);
INTERFACE BOOL msAPI_PVR_GetRetentionLimitJumpBackward(void);
