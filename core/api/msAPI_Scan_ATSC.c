...
EN_SCAN_RESULT msAPI_NTSC_Scan(MS_TP_SETTING_ATSC *pstTPSetting, U8 CurRFCh, EN_SCAN_ANT_TYPE CurChType)
{
    ...
    switch(enNTSCScanState)
    {
        case STATE_NTSC_SCAN_INIT:
            ...
            //msAPI_Tuner_Wait(NTSC_TUNER_PLL_STABLE_TIME);
            ...
            //msAPI_Tuner_Wait(NTSC_TUNER_PLL_STABLE_TIME*2); // remove for faster NTSC scan.
        #else
            msAPI_Timer_Delayms(NTSC_TUNER_PLL_STABLE_TIME);     //wait for PLL stable
        #endif
