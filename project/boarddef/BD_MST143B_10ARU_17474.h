...
#define PIN_97_IS_GPIO              GPIO_OUT_LOW
...
#define TS_CLK_INV                          0
#define FRONTEND_TUNER_TYPE                 ATBM_2040_TUNER
...
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_87 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_87 )
...
#define LED_GREEN_ON()                  mdrv_gpio_set_low( PIN_97 )
#define LED_GREEN_OFF()                 mdrv_gpio_set_high( PIN_97 )
...
#define ENABLE_TUNER_CLK_EXT    ENABLE
