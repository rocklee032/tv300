...
#define BD_MST143B_10ARU_17474          0x0B2D // 128 pin new -sz
...
#elif (MS_BOARD_TYPE_SEL == BD_MST143B_10ARU_17474)
    #include "BD_MST143B_10ARU_17474.h"
...
#if( STR_ENABLE )
    #if( !CHIP_SUPPORT_STR )
        #error "STR_ENABLE is true but CHIP_SUPPORT_STR is false!!"
    #endif
#endif
