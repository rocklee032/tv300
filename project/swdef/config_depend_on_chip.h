...
//----------------------------------------------------------------------------
   ...
   ||(CHIP_FAMILY_TYPE == CHIP_FAMILY_MARLON2)  \
    ...
    #define ENABLE_HDMI_4K_2K 1 // This is 4K_2K_30Hz
#else
  ...
  //#endif
   ...
   ||(CHIP_FAMILY_TYPE == CHIP_FAMILY_MARLON2)  \
    ...
    #define ENABLE_HDMI_4K_2K_60    1
#else
    #define ENABLE_HDMI_4K_2K_60    0
#endif
...
//----------------------------------------------------------------------------
    ...
    #define CHIP_SUPPORT_STR    1   //temp disable for bring up
#else
    #define CHIP_SUPPORT_STR    0
#endif
   ...
   ||(CHIP_FAMILY_TYPE == CHIP_FAMILY_MARLON2)  \
    ...
    #define GOP_SET_ALPHA_INVERSE   1
#else
    #define GOP_SET_ALPHA_INVERSE   0
#endif
