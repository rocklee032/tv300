...
//----------------------------------------------------------------------------------------------
#define ENABLE_ATSC_RRT     1

#define ENABLE_PARSE_SAME_DIMENSION_IN_RRT5_CAD ENABLE

#if(ENABLE_ATSC_RRT)
  #define ENABLE_ATSC_RRT_NEW_STRUCT    1
...
#ifndef ENABLE_ATSC_1000_CHANNEL
#define ENABLE_ATSC_1000_CHANNEL                    0//ENABLE
#endif

#ifndef ATSC_A_C_DIFF_DB
#define ATSC_A_C_DIFF_DB                        ENABLE // ATSC Air and Cable use different two DB
#endif
...
#define ENABLE_ATSC_CHLIST_DISP_TOGETHER        ENABLE//Air/Cable Display in One ChannelList
    #if ENABLE_ATSC_CHLIST_DISP_TOGETHER && !ATSC_A_C_DIFF_DB
    #error "ATSC_A_C_DIFF_DB = DISABLE!!! Can not support ENABLE_ATSC_CHLIST_DISP_TOGETHER"
    #endif
#else
