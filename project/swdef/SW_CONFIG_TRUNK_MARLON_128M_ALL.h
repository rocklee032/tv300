...
#if(ENABLE_ISDBT)
    #define ENABLE_EWBS                     DISABLE//DISABLE//ENABLE
#else
    #define ENABLE_EWBS                     DISABLE
#endif
...
//------DMP Application----------------------------------------------------------
  ...
  #if(ENABLE_BOOT_SPEED_UP)
    #define POWERON_MUSIC_MIN_HOLD_ON_TIME  1600   //When ENABLE_POWERON_MUSIC==1, music should play at least xx ms until cancelled
  #else
...
#define ENABLE_FileInMonitor                    ENABLE  // mantis 1288338, test case: TC14060600063
...
#define ENABLE_TNT_LCN                          ENABLE   //TNT HD   test case:TNT-007
...
#define ENABLE_ZIGGO_PARENTAL_RULE                    ENABLE_ZIGGO // for Ziggo parental UI
#define ENABLE_AUDIOLANG_SUBTITLELANG_IN_CHDB         ENABLE_ZIGGO

#define ENABLE_COMHEM                           ENABLE
#define ENABLE_STOFA                            ENABLE
#define ENABLE_TDT                              ENABLE

#if (ENABLE_COMHEM)
#define ENABLE_PVR_AESDMA                       ENABLE
#endif

#define ENABLE_REPLACEMENT_CH_FROM_ORIGINAL // TDT-0082, test case:TC14073100787

#undef DVBC_CERTIFICATION_AUTOSCAN_ENABLE
#define DVBC_CERTIFICATION_AUTOSCAN_ENABLE      ENABLE
...
#define ENABLE_RCSRDS_C                         ENABLE
#define MEDIASET_PREMIUM_SMART_CAM              ENABLE
...
#define ENABLE_SGP_MDA_CHAR_MAPPING             ENABLE // mantis 1537741, SGP_CHAR_4a.ts event short description display incorrect
...
#define ENABLE_ADJUST_TSCLOCK_PHASE     ENABLE

#define ENABLE_TEST_CMD_SCALER          1

//#define ENABLE_DTV_DB_DUMP      1

#define ENABLE_KEY_INFO_PRINT_SYS_INFO  1
