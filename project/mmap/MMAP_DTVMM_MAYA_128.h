...
/* VDEC_BITSTREAM   */
//co_buffer L1
#define VDEC_BITSTREAM_AVAILABLE                               0x000447C000
#define VDEC_BITSTREAM_ADR                                     0x000447C000  //Alignment 0x00008
...
/* SUBTITLE   */
//co_buffer L1
#define SUBTITLE_AVAILABLE                                     0x0004A7C000
#define SUBTITLE_ADR                                           0x0004A7C000  //Alignment 0x00020
...
//co_buffer L1
#define VDPLAYER_BITSTREAM_BUFF_AVAILABLE                      0x0004E1C000
#define VDPLAYER_BITSTREAM_BUFF_ADR                            0x0004E1C000  //Alignment 0x00010
...
//co_buffer L1
#define VDPLAYER_BITSTREAM_BUFF_EXT_AVAILABLE                  0x000521C000
#define VDPLAYER_BITSTREAM_BUFF_EXT_ADR                        0x000521C000  //Alignment 0x00010
...
/* VDPLAYER_DATA   */
//co_buffer L1
#define VDPLAYER_DATA_AVAILABLE                                0x000561C000
#define VDPLAYER_DATA_ADR                                      0x000561C000  //Alignment 0x01000
...
/* SCALER_DNR_BUF   */
//co_buffer L1
#define SCALER_DNR_BUF_AVAILABLE                               0x0005B1C000
#define SCALER_DNR_BUF_ADR                                     0x0005B1C000  //Alignment 0x00100
...
#define VDEC_FRAMEBUFFER_SD_LEN                                0x0001B00000
#define VDEC_FRAMEBUFFER_SD_MEMORY_TYPE                        (MIU0 | SW | CO_BUF_L2 | WRITE_BACK)

/* VDEC_BITSTREAM_SD   */
//co_buffer L2
#define VDEC_BITSTREAM_SD_AVAILABLE                            0x000447C000
#define VDEC_BITSTREAM_SD_ADR                                  0x000447C000  //Alignment 0x00008
...
/* SUBTITLE_DTV   */
//co_buffer L2
#define SUBTITLE_DTV_AVAILABLE                                 0x0004A7C000
#define SUBTITLE_DTV_ADR                                       0x0004A7C000  //Alignment 0x00020
...
/* PVR_TRICK_MODE   */
//co_buffer L2
#define PVR_TRICK_MODE_AVAILABLE                               0x0004E1C000
#define PVR_TRICK_MODE_ADR                                     0x0004E1C000  //Alignment 0x00010
...
/* PVR_READ_SDRAM   */
//co_buffer L2
#define PVR_READ_SDRAM_AVAILABLE                               0x000511C000
#define PVR_READ_SDRAM_ADR                                     0x000511C000  //Alignment 0x00010
...
/* PVR_MHEG_ALIGN   */
//co_buffer L2
#define PVR_MHEG_ALIGN_AVAILABLE                               0x00052CC000
#define PVR_MHEG_ALIGN_ADR                                     0x00052CC000  //Alignment 0x00010
...
/* PVR_BROWSER_BUFFER   */
//co_buffer L2
#define PVR_BROWSER_BUFFER_AVAILABLE                           0x00052FC000
#define PVR_BROWSER_BUFFER_ADR                                 0x00052FC000  //Alignment 0x00010
...
//co_buffer L2
#define PVR_READ_METADATA_BUFFER_AVAILABLE                     0x00054FC000
#define PVR_READ_METADATA_BUFFER_ADR                           0x00054FC000  //Alignment 0x00010
...
//co_buffer L2
#define PVR_WRITE_METADATA_BUFFER_AVAILABLE                    0x00054FCC00
#define PVR_WRITE_METADATA_BUFFER_ADR                          0x00054FCC00  //Alignment 0x00010
...
/* PVR_WRITE_SDRAM   */
//co_buffer L2
#define PVR_WRITE_SDRAM_AVAILABLE                              0x000555CC00
#define PVR_WRITE_SDRAM_ADR                                    0x000555D000  //Alignment 0x01000
...
/* PVR_IO_BUFFER   */
//co_buffer L2
#define PVR_IO_BUFFER_AVAILABLE                                0x00058BD000
#define PVR_IO_BUFFER_ADR                                      0x00058BD000  //Alignment 0x01000
...
/* BULK_FILE_SYSTEM   */
//co_buffer L2
#define BULK_FILE_SYSTEM_AVAILABLE                             0x00058CD000
#define BULK_FILE_SYSTEM_ADR                                   0x00058CD000  //Alignment 0x01000
...
/* EVENTDB_SDRAM   */
//co_buffer L2
#define EVENTDB_SDRAM_AVAILABLE                                0x00058D3000
#define EVENTDB_SDRAM_ADR                                      0x00058D3000  //Alignment 0x00010
...
/* EPGEXTDB_SDRAM   */
//co_buffer L2
#define EPGEXTDB_SDRAM_AVAILABLE                               0x0005DD3000
#define EPGEXTDB_SDRAM_ADR                                     0x0005DD3000  //Alignment 0x00010
...
/* TTXBUF_START   */
//co_buffer L2
#define TTXBUF_START_AVAILABLE                                 0x00067D3000
#define TTXBUF_START_ADR                                       0x00067D3000  //Alignment 0x00008
...
/* SI_MONITOR_DB   */
//co_buffer L2
#define SI_MONITOR_DB_AVAILABLE                                0x00068A7800
#define SI_MONITOR_DB_ADR                                      0x00068A7800  //Alignment 0x00008
...
/* SRV_NAME_BUF   */
//co_buffer L2
#define SRV_NAME_BUF_AVAILABLE                                 0x00068B6800
#define SRV_NAME_BUF_ADR                                       0x00068B6800  //Alignment 0x00008
...
/* EIT_PF_STRING_BUF   */
//co_buffer L2
#define EIT_PF_STRING_BUF_AVAILABLE                            0x00068B7800
#define EIT_PF_STRING_BUF_ADR                                  0x00068B7800  //Alignment 0x00008
...
/* MMI_TEXTSTRING   */
//co_buffer L2
#define MMI_TEXTSTRING_AVAILABLE                               0x00068BB800
#define MMI_TEXTSTRING_ADR                                     0x00068BB800  //Alignment 0x00010
...
/* OADSEC_BUFFER   */
//co_buffer L2
#define OADSEC_BUFFER_AVAILABLE                                0x00068BC800
#define OADSEC_BUFFER_ADR                                      0x00068BC800  //Alignment 0x00010
...
/* SCALER_DNR_BUF_DTV   */
//co_buffer L2
#define SCALER_DNR_BUF_DTV_AVAILABLE                           0x00068D0800
#define SCALER_DNR_BUF_DTV_ADR                                 0x00068D0800  //Alignment 0x00100
...
/* RRT5_DIM_START   */
//co_buffer L2
#define RRT5_DIM_START_AVAILABLE                               0x00074D0800
#define RRT5_DIM_START_ADR                                     0x00074D0800  //Alignment 0x00008
...
/* GOP_GWIN_RB2   */
//co_buffer L2
#define GOP_GWIN_RB2_AVAILABLE                                 0x00074E0800
#define GOP_GWIN_RB2_ADR                                       0x00074E0800  //Alignment 0x00020
...
#define VDEC_FB_ALIGN_L3_LEN                                   0x0001300000
#define VDEC_FB_ALIGN_L3_MEMORY_TYPE                           (MIU0 | SW | CO_BUF_L3 | WRITE_BACK)

/* VDEC_BITSTREAM_ALIGN_L3   */
//co_buffer L3
#define VDEC_BITSTREAM_ALIGN_L3_AVAILABLE                      0x000447C000
#define VDEC_BITSTREAM_ALIGN_L3_ADR                            0x000447C000  //Alignment 0
...
/* MHEG5_BUFFER   */
//co_buffer L3
#define MHEG5_BUFFER_AVAILABLE                                 0x0004A7C000
#define MHEG5_BUFFER_ADR                                       0x0004A7C000  //Alignment 0x00100
...
/* MHEG5_JPEG   */
//co_buffer L3
#define MHEG5_JPEG_AVAILABLE                                   0x00052FC000
#define MHEG5_JPEG_ADR                                         0x00052FC000  //Alignment 0x00100
...
/* NONE_ALIGN_WITH_TTX   */
//co_buffer L3
#define NONE_ALIGN_WITH_TTX_AVAILABLE                          0x00057FC000
#define NONE_ALIGN_WITH_TTX_ADR                                0x00057FC000  //Alignment 0x01000
...
//co_buffer L3
#define CCVBI_RINGBUFFER_START_AVAILABLE                       0x00067D3000
#define CCVBI_RINGBUFFER_START_ADR                             0x00067D3000  //Alignment 0x00008
...
/* DTVCC_BLOCK0_START   */
//co_buffer L3
#define DTVCC_BLOCK0_START_AVAILABLE                           0x00067D3100
#define DTVCC_BLOCK0_START_ADR                                 0x00067D3100  //Alignment 0x00008
...
/* DTVCC_BLOCK1_START   */
//co_buffer L3
#define DTVCC_BLOCK1_START_AVAILABLE                           0x00067DF100
#define DTVCC_BLOCK1_START_ADR                                 0x00067DF100  //Alignment 0x00008
...
/* DTVCC_PES_START   */
//co_buffer L3
#define DTVCC_PES_START_AVAILABLE                              0x00067E0100
#define DTVCC_PES_START_ADR                                    0x00067E0100  //Alignment 0x00008
...
/* DTVCC_QUEUE_START   */
//co_buffer L3
#define DTVCC_QUEUE_START_AVAILABLE                            0x00067E1100
#define DTVCC_QUEUE_START_ADR                                  0x00067E1100  //Alignment 0x00008
...
//co_buffer L3
#define CC608MVD_RINGBUFFER_START_AVAILABLE                    0x0006881100
#define CC608MVD_RINGBUFFER_START_ADR                          0x0006881100  //Alignment 0x00020
...
//co_buffer L3
#define CC708MVD_RINGBUFFER_START_AVAILABLE                    0x0006885100
#define CC708MVD_RINGBUFFER_START_ADR                          0x0006885100  //Alignment 0x00020
...
/* CCMVD_CACHE_BUFFER   */
//co_buffer L3
#define CCMVD_CACHE_BUFFER_AVAILABLE                           0x0006889900
#define CCMVD_CACHE_BUFFER_ADR                                 0x0006889900  //Alignment 0x00008
...
//co_buffer L3
#define CC608_DISPBUFFER_START_AVAILABLE                       0x000688B900
#define CC608_DISPBUFFER_START_ADR                             0x000688B900  //Alignment 0x00008
...
/* TCVT_BUFFER_START   */
//co_buffer L3
#define TCVT_BUFFER_START_AVAILABLE                            0x000688D900
#define TCVT_BUFFER_START_ADR                                  0x000688D900  //Alignment 0x00020
...
/* CVCT_BUFFER_START   */
//co_buffer L3
#define CVCT_BUFFER_START_AVAILABLE                            0x000688E900
#define CVCT_BUFFER_START_ADR                                  0x000688E900  //Alignment 0x00020
