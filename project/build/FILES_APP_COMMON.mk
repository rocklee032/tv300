...
APP_FILES +=        \
        ...
        $(TVAP)/customer/Cus_ISR.c						\
        $(TVAP)/customer/Cus_MultiTask.c						\
        $(TVAP)/customer/Cus_UartCmd.c						\
        $(TVAP)/customer/edid/MApp_Edid_Table.c						\
        $(TVAP)/dvb/app/MApp_DataBase_CH.c						\
        $(TVAP)/dvb/app/MApp_DTV.c						\
        $(TVAP)/dvb/app/MApp_DVB_ServiceMonitor.c						\
		...
		$(TVAP)/dvb/func/MApp_Func_EWBS.c              \
...
APP_FILES +=        \
        ...
        $(TVAP)/common/app/MApp_HashKey.c						    \
