...
#MM_FILES += $(ROOT)/core/middleware/tts/mst_rsrc.c
  ...
  ifeq ($(OS_TYPE),nos_arm)
      ifeq ($(MS_TTS_LIB_SEL),MS_TTS_LIB_EN)	
        TTS_LIB_FOLDER = cbr/arm/En
      else ifeq ($(MS_TTS_LIB_SEL),MS_TTS_LIB_EN_SP_FR)	
        TTS_LIB_FOLDER = cbr/arm/EnSpFr
      else ifeq ($(MS_TTS_LIB_SEL),MS_TTS_LIB_EN_KR)	
        TTS_LIB_FOLDER = cbr/arm/EnKr
      else ifeq ($(MS_TTS_LIB_SEL),MS_TTS_LIB_EN_SP_FR_KR)	
        TTS_LIB_FOLDER = cbr/arm/EnSpFrKr
      endif
 
  else
      ifeq ($(MS_TTS_LIB_SEL),MS_TTS_LIB_EN)	
        TTS_LIB_FOLDER = cbr/aeon/En
      else ifeq ($(MS_TTS_LIB_SEL),MS_TTS_LIB_EN_OS)	
        TTS_LIB_FOLDER = cbr/aeon/En_Os
      else ifeq ($(MS_TTS_LIB_SEL),MS_TTS_LIB_EN_SP_FR)	
    ...
    ifeq ($(OS_TYPE),nos_arm)
        DTV_LIB += $(ROOT)/core/middleware/tts/libMsTTS_arm.a 	
        #DTV_LIB += $(ROOT)/core/middleware/tts/mst_rsrc/mst_rsrc_arm.a 	
    else
