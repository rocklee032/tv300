...
#-----------------------------------------------
projName[1]=R2_WHISKY_128M_ATSC
boardType[1]=BD_MST233B_D01A_S
tunerType[1]=MxL_661SI_TUNER
swType[1]=SW_CONFIG_TRUNK_WHISKY_128M_ALL
#-----------------------------------------------
...
#-----------------------------------------------
projName[3]=R2_WHISKY_64M_ATSC_4M_TTS_EN
boardType[3]=BD_MST090B_10ANU_15213
tunerType[3]=MxL_661SI_TUNER
swType[3]=SW_CONFIG_TRUNK_WHISKY_64M_ALL
#-----------------------------------------------
...
#-----------------------------------------------
projName[5]=R2_WHISKY_64M_ATSC
boardType[5]=BD_MST090B_10ANU_15213
tunerType[5]=MxL_661SI_TUNER
swType[5]=SW_CONFIG_TRUNK_WHISKY_64M_ALL
#-----------------------------------------------
# socket board
projName[6]=R2_WHISKY_64M_ATSC
boardType[6]=BD_MST233B_D01A_S
tunerType[6]=MxL_661SI_TUNER
swType[6]=SW_CONFIG_TRUNK_WHISKY_64M_ALL
#-----------------------------------------------
# socket board
projName[7]=R2_WHISKY_64M_ATSC
boardType[7]=BD_MST233A_D01A_S
tunerType[7]=MxL_661SI_TUNER
swType[7]=SW_CONFIG_TRUNK_WHISKY_64M_ALL
#-----------------------------------------------
# socket board
projName[8]=R2_WHISKY_64M_ATSC_TTS_EN_ES_FR
boardType[8]=BD_MST233B_D01A_S
