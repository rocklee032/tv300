...
MSCOMP_ZDEC = "./scripts/util/mscomp_zdec -e "

FLAG_COMPRESS = 0x01
FLAG_FLASH2   = 0x02
FLAG_MSCOMPRESS = 0x04
FLAG_MSCOMPRESS7 = 0x08
FLAG_MSCOMPRESS_ZDEC = 0x10
FLAG_ALL_COMPRESS = (FLAG_COMPRESS|FLAG_MSCOMPRESS|FLAG_MSCOMPRESS7|FLAG_MSCOMPRESS_ZDEC)
    ...
    for l in f_binid:
        ...
        if (m):
            ...
            if m.group(6) is not None:
                ...
                if m.group(6).find('-z') >= 0:
                    flags |= FLAG_MSCOMPRESS_ZDEC
            ...
            try:
                if bMultiFlash and (flags & FLAG_FLASH2):
                    ...
                    if flags & FLAG_MSCOMPRESS7:
    				    ...
    				    fn = fn + "c"
                    if flags & FLAG_MSCOMPRESS_ZDEC:
    				    #print "fn=%s\n" % fn
    				    os.system(MSCOMP_ZDEC + dir + "/../" + fn + "  " + dir + "/../" + fn + "c");
    				    fn = fn + "c"
                    b = open(dir + "/../" + fn, "rb")
                    d = b.read()
                    ...
                    f.write(struct.pack('>B', (flags & FLAG_ALL_COMPRESS)))
