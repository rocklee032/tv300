...
//csm,13'
signed int   SiLabs_API_TER_ATVConfig			  (SILABS_FE_Context* front_end);//csm,change
signed int   SiLabs_API_TER_Tuner_ATV_SetAgcSpeed(SILABS_FE_Context *front_end,unsigned char agc_speed);
//end
signed int   SiLabs_API_TER_Tuner_ATV_Tune       (SILABS_FE_Context *front_end,unsigned char tunint_check,unsigned int AtvTimeout);//csm,13'
//csm,13'
