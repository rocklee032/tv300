...
#define SiLabs_TER_Tuner_DTVTune Si2151_DTVTune
	...
	api->cmd->config_pins.gpio1_mode               = Si2151_CONFIG_PINS_CMD_GPIO1_MODE_NO_CHANGE; \
	api->cmd->config_pins.gpio2_mode               = Si2151_CONFIG_PINS_CMD_GPIO2_MODE_NO_CHANGE; \
	api->cmd->config_pins.gpio1_read               = Si2151_CONFIG_PINS_CMD_GPIO1_READ_READ; \
	api->cmd->config_pins.gpio2_read               = Si2151_CONFIG_PINS_CMD_GPIO2_READ_READ; \
	api->cmd->config_pins.agc1_mode                = Si2151_CONFIG_PINS_CMD_AGC1_MODE_ATV_AGC; \
	api->cmd->config_pins.agc1_read                = Si2151_CONFIG_PINS_CMD_AGC1_READ_READ; \
	api->cmd->config_pins.agc2_mode                = Si2151_CONFIG_PINS_CMD_AGC2_MODE_NO_CHANGE; \
	api->cmd->config_pins.agc2_read                = Si2151_CONFIG_PINS_CMD_AGC2_READ_READ; \
	api->cmd->config_pins.xout_mode                = Si2151_CONFIG_PINS_CMD_XOUT_MODE_NO_CHANGE; \
	Si2151_L1_SendCommand2(api,Si2151_CONFIG_PINS_CMD_CODE); \
    ...
    api->cmd->config_pins.xout_mode                = Si2151_CONFIG_PINS_CMD_XOUT_MODE_NO_CHANGE;\
    if (fef == 0) {\
      api->cmd->config_pins.gpio1_mode          = Si2151_CONFIG_PINS_CMD_GPIO1_MODE_DISABLE;\
    } else {\
       api->cmd->config_pins.gpio1_mode          = Si2151_CONFIG_PINS_CMD_GPIO1_MODE_DTV_FREEZE_HIGH;\
    }\
    Si2151_L1_SendCommand2(api, Si2151_CONFIG_PINS_CMD_CODE);\
