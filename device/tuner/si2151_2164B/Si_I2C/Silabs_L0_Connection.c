    ...
    )
{
    ...
    if(MDrv_IIC_ReadBytes((((U16)TUNER_IIC_BUS<<8)|i2c_slave_id), (U8) subadrlen, subadrptr, (U16) datalen, dataptr) == false)
    {
        bRet = 0;
        printf("\nTuner_IIC read  fail\n");
    }
    ...
    )
{
    ...
    if(MDrv_IIC_WriteBytes((((U16)TUNER_IIC_BUS<<8)|i2c_slave_id), (U8) subadrlen, subadrptr, (U16) datalen, dataptr) == false)
    {
        bRet = 0;
        printf("\nTuner_IIC read  fail\n");
    }
