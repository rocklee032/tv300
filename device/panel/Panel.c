...
BOOLEAN MApi_PanelParameter_LoadTable(U8 u8PanelIndex)
{
    ...
    stPanelBinTbl.stOldPanelTypeFromUtopia.m_wPanelMinVTotal =
            (WORD) (stPanelBinStruct.stPanelTbl.m_bPanelMinVTotal_L
                   |stPanelBinStruct.stPanelTbl.m_bPanelMinVTotal_H << 8);
    ...
    stPanelBinTbl.u16PanelMinDCLK =
            (WORD) (stPanelBinStruct.stPanelTbl.u8PanelMinDCLK_L
                   |stPanelBinStruct.stPanelTbl.u8PanelMinDCLK_H << 8);
...
void MApi_PNL_SetBackLight(MS_BOOL bEnable)
{
    ...
    DEBUG_BACKLIGHT( PRINT_CURRENT_LINE(); );
    ...
    if ( bEnable )
    {
        ...
        DEBUG_BACKLIGHT( printf("u8PWM_Value=%u\n", u8PWM_Value); );
