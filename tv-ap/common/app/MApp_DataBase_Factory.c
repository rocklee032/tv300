...
#define DB_FAC_MAGIC_ID_1   (0x55AA1314)
#define DB_FAC_MAGIC_ID_2   (0xAA131400 + ((1)&0xFF) )
...
void MApp_DB_Factory_ResetAll(void)
{
    ...
    DB_FAC_ERROR( printf("MApp_DB_Factory_ResetAll()\n"); );

    // Init all factory variable
    MApp_DataBase_RestoreDefaultFactorySetting();

    G_FACTORY_SETTING.u32MagicId_1 = DB_FAC_MAGIC_ID_1;
    G_FACTORY_SETTING.u32MagicId_2 = DB_FAC_MAGIC_ID_2;
...
void MApp_DB_Factory_Init(void)
{
    ...
    DEBUG_DB_FACTORY( printf("MApp_DB_Factory_Init() at %u\n", MsOS_GetSystemTime()); );
    ...
    {
        bNeedResetAll = TRUE;
        DB_FAC_ERROR( printf("\nError: Load factory from flash failed\n"); );
    }
    else
    {
    }
    ...
    // Check magic ID...
    if( bNeedResetAll == FALSE )
    {
        if( G_FACTORY_SETTING.u32MagicId_1 != DB_FAC_MAGIC_ID_1 )
        {
            DB_FAC_ERROR( printf("\nError: Factory magic id-1 changed: 0x%X,0x%X\n", DB_FAC_MAGIC_ID_1, G_FACTORY_SETTING.u32MagicId_1); );
            bNeedResetAll = TRUE;
        }
        if( G_FACTORY_SETTING.u32MagicId_2 != DB_FAC_MAGIC_ID_2 )
        {
            DB_FAC_ERROR( printf("\nError: Factory magic id-2 changed: 0x%X,0x%X\n", DB_FAC_MAGIC_ID_2, G_FACTORY_SETTING.u32MagicId_2); );
            bNeedResetAll = TRUE;
        }
    }
    ...
    if( bNeedResetAll == FALSE )
    {
        U16 u16CheckSum = _MApp_DB_Factory_CalCheckSum();
    ...
    DEBUG_DB_FACTORY( printf("MApp_DB_Factory_Init() end at %u\n", MsOS_GetSystemTime()); );
}
