...
///  @author MStarSemi @date 2007/1/25
///////////////////////////////////////////////////////////////////////////////
LPTSTR MApp_ZUI_API_GetStringSpecificLanguage(U16 id, U8 u8MenuLanguage)
{
    ...
    OSDcp_readbin_string_ptr(u8MenuLanguage, id, (U16*)CHAR_BUFFER);
...
{
    U8 u8MenuLanguage = GET_OSD_MENU_LANGUAGE();
    ...
    OSDcp_readbin_string_ptr(u8MenuLanguage, id, (U16*)str);
}
