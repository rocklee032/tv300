...
void MApp_Edid_CorrectCheckSum(U8* pu8EdidTbl)
{
    ...
    DEBUG_EDID_TBL( printf("CheckSum[7F]: 0x%X, 0x%X ",  u8CheckSum, pu8EdidTbl[127]); );

    pu8EdidTbl[127] = 256 - u8CheckSum;
    ...
    DEBUG_EDID_TBL( printf("CheckSum[FF]: 0x%X, 0x%X ",  u8CheckSum, pu8EdidTbl[255]); );
