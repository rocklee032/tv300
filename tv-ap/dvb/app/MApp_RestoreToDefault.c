...
EN_OSD_COUNTRY_SETTING MApp_DataBase_Get_Default_Country(void)
{
    ...
    {
        return (EN_OSD_COUNTRY_SETTING)ISDB_DEFAULT_COUNTRY;
    }
    else
    {
...
#if ENABLE_BAT_SCAN
    stGenSetting.g_SysSetting.eBouquetID = DEFAULT_CURRENT_REGION;
#endif
...
#if(ENABLE_GAMEMODE)
    // After UI function is OK, change defalut value to 0
    stGenSetting.g_SysSetting.u8GameMode = 0;//DISABLE; // 0: Off, 1: On
#endif

#if ENABLE_ISDBT
    LAST_WATCHED_ANTENNA_TYPE = ANTENNA_DTV_TYPE;
#endif
}
...
void MApp_DataBase_RestoreDefault_MiscSetting(void)
{
    ...
    stGenSetting.stMiscSetting.u8EWBSLocationCode[0] = 0;
    stGenSetting.stMiscSetting.u8EWBSLocationCode[1] = 0;
    stGenSetting.stMiscSetting.u8EWBSLocationCode[2] = 0;
    stGenSetting.stMiscSetting.u8EWBSLocationCode[3] = 0;
...
void MApp_DataBase_RestoreDefault_CIPlus(void)
{
    ...
    stGenSetting.stCIPlusSetting.u8Opv2InstallSource = (U8)UI_INPUT_SOURCE_NONE;
