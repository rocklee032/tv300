...
void MApp_PQ_Set_ColorTemp( SCALER_WIN eWindow)
{
    ...
    DEBUG_XC_COLOR_TEMP( printf("MApp_PQ_Set_ColorTemp()\n"); );
    DEBUG_XC_COLOR_TEMP( printf("u8ColorTempIdx=%u\n", u8ColorTempIdx); );
...
void MApp_XC_PQ_Set_Saturation(SCALER_WIN eWindow, BOOL bSetInVBlanking)
{
    BOOLEAN bBackupAceWaitVSync = MDrv_ACE_GetSkipWaitVsync(eWindow);
