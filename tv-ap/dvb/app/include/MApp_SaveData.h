...
#else
    #define RM_CATV_VIR_CH_START_ADR        RM_AIR_VIR_CH_START_ADR
    #define RM_CATV_VIR_CH_LEN              RM_AIR_VIR_CH_LEN

    #define RM_CATV_CH_SETTING_START_ADR    RM_AIR_CH_SETTING_START_ADR
    #define RM_CATV_CH_SETTING_LEN          RM_AIR_CH_SETTING_LEN
#endif
...
#else
    #define RM_ATSC_CATV_RF_CH_START_ADR    (RM_ATSC_RF_CH_START_ADR)
    #define RM_ATSC_CATV_RF_CH_LEN          (sizeof(MS_RF_CHANNEL_new) * (MAX_CATV_PHYSICAL_CH_NUM+1))
    #define RM_ATSC_AIR_RF_CH_START_ADR     RM_ATSC_CATV_RF_CH_START_ADR
    #define RM_ATSC_AIR_RF_CH_LEN           RM_ATSC_CATV_RF_CH_LEN
    #define RM_ATSC_RF_CH_LEN               (RM_ATSC_CATV_RF_CH_LEN)
#endif
