...
typedef enum
{
    E_PVR_FILE_CHANGE_NONE,
    E_PVR_FILE_CHANGE_FILE,
    E_PVR_FILE_CHANGE_FORWARD,
    E_PVR_FILE_CHANGE_BACKWARD,
} enPVRFileChange;
/*function ======================================================================================*/
#ifdef MAPP_PVR_C
    #define INTERFACE
...
INTERFACE void            MApp_PVR_SetFileChangeStatus(enPVRFileChange enFileChangeStatus);
INTERFACE enPVRFileChange MApp_PVR_GetFileChangeStatus(void);
