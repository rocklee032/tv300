...
#define DEFAULT_SUB_LANG                        LANGUAGE_ENGLISH
    ...
    #define DEFAULT_TUNING_COUNTRY              (EN_OSD_COUNTRY_SETTING)ISDB_DEFAULT_COUNTRY
#else
...
#define DEFAULT_TUNING_UNITYMEDIA_COUNTRY             OSD_COUNTRY_GERMANY
#define DEFAULT_TUNING_ZIGGO_COUNTRY                  OSD_COUNTRY_NETHERLANDS
#define DEFAULT_TUNING_UPC_COUNTRY                    OSD_COUNTRY_NETHERLANDS
#define DEFAULT_TUNING_VIRGINMEDIA_COUNTRY            OSD_COUNTRY_IRELAND
#define DEFAULT_TUNING_CABLEREADY_COUNTRY             OSD_COUNTRY_FINLAND
#define DEFAULT_TUNING_COMHEM_COUNTRY                 OSD_COUNTRY_SWEDEN
#define DEFAULT_TUNING_STOFA_COUNTRY                  OSD_COUNTRY_DENMARK
#endif
