...
// OPv2
INTERFACE U8 MApp_CI_GetCurrentOpIndexByCicamId(U32 u32CicamId);
INTERFACE void MApp_CI_EnterCiOperatorProfileTyep2(U32 u32CicamIdentifier);
INTERFACE EN_OP_TYPE MApp_CI_GetOperatorProfileType(void);
INTERFACE void MApp_CI_OP_SendOPNitManagement(void);
INTERFACE void MApp_CI_CheckOpCacheInfo(void);
INTERFACE BOOLEAN MApp_CI_GetProfileTypeByIndex(U8 u8Index , U8* u8ProfileType);
#endif
/**********************************************************/
