...
INTERFACE void            MApp_Playback_SetUIUpdate(BOOLEAN bUpdate);
INTERFACE BOOLEAN         MApp_Playback_GetUIUpdate(void);
#if ((ENABLE_CI_PLUS == 1) && (ENABLE_CIPLUS_PVR == 1))
INTERFACE BOOLEAN MApp_Playback_RetentionLimitMonitor(U32 u32PlaybackTime, U32* u32JumpTime);
#endif
INTERFACE BOOLEAN MApp_Playback_IsDiffFile(void);
