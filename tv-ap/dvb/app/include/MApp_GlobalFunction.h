...
#if ENABLE_EWBS
#define EWBS_AREA_SETTING                       MApp_GetEWBSAreaSetting()
#endif
...
#if 0
#define MApp_IsSrcHasSignal(win)    (printf("%s %u call Signal\n", __FILE__, __LINE__ )?(MApp_IsSrcHasSignal_2((win))):(0))
INTERFACE BOOLEAN MApp_IsSrcHasSignal_2(SCALER_WIN eWindow);
#else
...
#if ENABLE_EWBS
INTERFACE EN_OSD_EWBS_AREA_SETTING MApp_GetEWBSAreaSetting(void);
#endif
#if(DVBC_CERTIFICATION_AUTOSCAN_ENABLE)
