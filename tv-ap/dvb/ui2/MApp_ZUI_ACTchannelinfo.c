...
static LPTSTR _MApp_ZUI_ACT_GetInputSourceResolution(SCALER_WIN eWindow)
{
    ...
    {
        if( !MApp_DTV_Is_VDECLock() ) //if( MApp_IsSrcHasSignal(eWindow) )
            return NULL;

        VDEC_DispInfo stVDEC_DispInfo;
        BOOLEAN bRet = msAPI_VID_GetVidInfo(&stVDEC_DispInfo);
        if( FALSE == bRet )
        {
            return NULL;
        }
        ...
        {
            u16V = stVDEC_DispInfo.u16VerSize;
            ...
            {
                *str++ = CHAR_p;
                if( stVDEC_DispInfo.u8Interlace )
                {
    ...
    */
        ...
        //#endif
            ...
            #endif
            {
                ...
                {
                    u16Len = UiMenuStr_GetVChip1RatingString(buf, sizeof(buf));
