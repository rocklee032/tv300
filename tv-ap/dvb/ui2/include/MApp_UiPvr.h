...
INTERFACE S16 MApp_UiPvr_PlaybackGetABLoopPercentage(void);
...
INTERFACE S16 MApp_UiPvr_PlaybackGetABLoopPercentage(void);
INTERFACE void MApp_UiPvr_DrawRetentionLimitBlocks(void);
#endif
INTERFACE void MApp_UiPvr_SetPercentProgressBar(void);
/***************************************************************************************/
