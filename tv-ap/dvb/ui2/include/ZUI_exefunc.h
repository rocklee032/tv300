...
#if ENABLE_EWBS
	EN_EXE_GOTO_MONITORING_CHANNEL_LIST,
#endif
...
//    EN_EXE_MUTE_AUDIO_VOLUME,                   ///< mute audio volume
    ...
    EN_EXE_GOTO_GAMEMODE_PAGE,	 ///< goto gamemode page
...
//#endif
    ...
    EN_EXE_POP_REGION_SELECT,
    EN_EXE_SELECT_REGION_CONFIRM,
    EN_EXE_SELECT_REGION_NEXT,
    EN_EXE_SELECT_REGION_PREV,
    
    EN_EXE_GOTO_EWBS_INFO_PAGE,
    EN_EXE_EWBS_SELECT,
    EN_EXE_GOTO_INPUT_EWBS_LOCATION_COMMON_DLG,
    EN_EXE_EWBS_AREA_TYPE_SWITCH,
    EN_EXE_GOTO_EWBS_CONFIRM_DLG,

	EN_EXE_INPUT_EWBS_NUM_KEY0,
    EN_EXE_INPUT_EWBS_NUM_KEY1,
    EN_EXE_INPUT_EWBS_NUM_KEY2,
    EN_EXE_INPUT_EWBS_NUM_KEY3,
    EN_EXE_INPUT_EWBS_NUM_KEY4,
    EN_EXE_INPUT_EWBS_NUM_KEY5,
    EN_EXE_INPUT_EWBS_NUM_KEY6,
    EN_EXE_INPUT_EWBS_NUM_KEY7,
    EN_EXE_INPUT_EWBS_NUM_KEY8,
    EN_EXE_INPUT_EWBS_NUM_KEY9,
    EN_EXE_INPUT_EWBS_EWBS_DONE,
    EN_EXE_INPUT_EWBS_EWBS_CANEL,

	EN_EXE_CLOSE_EWBS_CONFIRM,
