            ...
            switch(u8Item)
            {
                ...
                case 1: // from case MAPP_UIMENUFUNC_ADJUSTADC_CALIBRATION:
                    ...
                    if(MApp_IsSrcHasSignal(MAIN_WINDOW))
                    {
                        ...
                        {
                            g_ADCCalibrationResult =
                                MApp_RGB_Setting_Auto(E_XC_EXTERNAL_CALIBRATION,
                                                      MAIN_WINDOW, ADC_AUTO_CAL_FOR_FAC_MENU);
                        }
                        ...
                        {
                          #if 1 // testing for Coverity 195446 Unchecked return value
                            g_ADCCalibrationResult =
                                MApp_YPbPr_Setting_Auto(E_XC_EXTERNAL_CALIBRATION,
                                                        MAIN_WINDOW, ADC_AUTO_CAL_FOR_FAC_MENU,
                                                        ((MApi_XC_Sys_IsSrcHD(MAIN_WINDOW))?(TRUE):(FALSE)));

                          #else
                            g_ADCCalibrationResult =
                                MApp_YPbPr_Setting_Auto(E_XC_EXTERNAL_CALIBRATION,
                                                        MAIN_WINDOW, ADC_AUTO_CAL_FOR_FAC_MENU,
                                                        MApi_XC_Sys_IsSrcHD(MAIN_WINDOW));
                          #endif
                        }
                        else
                        {
