...
BOOLEAN g_bIsLockedOpen = FALSE;
BOOLEAN g_bIsPvrPlay = FALSE;
...
extern BOOLEAN MApp_ZUI_GetChannelLock(void);
...
*/
    switch(key)
    {
        ...
        case VK_PLAY:
            ...
            {
                g_bIsPvrPlay = TRUE;
                if(FALSE == MApp_UiPvr_Browser_KeyProcessor(KEY_PLAY))
                {
                    MApp_ZUI_ACT_StartupOSD(E_OSD_MESSAGE_BOX);    //modify by munez
