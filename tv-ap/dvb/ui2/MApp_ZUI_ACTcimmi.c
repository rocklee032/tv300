...
BOOLEAN MApp_ZUI_ACT_ExecuteCIMMIAction(U16 act)
{
    switch(act)
    {
        ...
        case EN_EXE_POWEROFF:
            ...
            _enTargetCIMMIState = STATE_CIMMI_GOTO_STANDBY;
            return TRUE;
        ...
        case EN_EXE_REPAINT_CIMMI_PAGE:
            if (_pInfo)
            {
                ...
                //MApp_ZUI_API_ShowWindow(HWND_MAINFRAME, SW_HIDE);          //if hide mainframe,HWND_OP_REFRESH_MSGBOX freshen
