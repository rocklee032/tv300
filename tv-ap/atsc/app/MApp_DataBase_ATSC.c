...
static U8 s_ATSC_u8PhyChMaxIdx = 0;
...
#if 1
    if( u16SrvIdx > s_ATSC_u8PhyChMaxIdx )
    {
...
void MApp_DB_ATSC_InitBaseAddr(EN_ANT_TYPE enAntennaType)
{
    ...
    if( enAntennaType == ANT_AIR )
    {
        ...
        s_ATSC_u8PhyChMaxIdx = MAX_AIR_PHYSICAL_CH_NUM - 1;
    ...
    else //ANT_CATV
    {
        ...
        s_ATSC_u8PhyChMaxIdx = MAX_CATV_PHYSICAL_CH_NUM - 1;
...
void MApp_DB_ATSC_ResetAllChData(void)
{
    ...
    // Clear all RF channel
    {
        ...
        for(u8PhyIdx = 0; u8PhyIdx <= s_ATSC_u8PhyChMaxIdx; u8PhyIdx ++)
        {
...
void MApp_DB_ATSC_LoadAllChData(void)
{
    ...
    DEBUG_DB_ATSC(printf("stChSetting.u32MagicCode_1=0x%X\n", stChSetting.u32MagicCode_1); );
    DEBUG_DB_ATSC(printf("stChSetting.u32MagicCode_2=0x%X\n", stChSetting.u32MagicCode_2); );
