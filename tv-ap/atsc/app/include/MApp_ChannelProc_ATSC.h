...
// Always be current virtual channel
INTERFACE MS_VIRTUAL_CHANNEL g_ATSC_stCurVirCh;
...
INTERFACE U16 MApp_ChanProc_GetPreProgIndexOfMainList( void );
...
U16 MApp_GetPrevNextProgramIndex_ByProgIndex(BOOLEAN bPreProgram, U16 u16ProgIndex, BOOLEAN bSkipHide);
//#endif
